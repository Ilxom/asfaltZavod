...
public class DD_TIME_EX extends Structure {
	public DD_TIME_EX(Pointer p) {
		super(p,ALIGN_NONE);
		useMemory(p);
		read();
	}
	...
	public static class ByReference extends DD_TIME_EX implements Structure.ByReference {
	}

	public static class ByValue extends DD_TIME_EX implements Structure.ByValue {
	}
	...
	public short year; // Year (current year)
